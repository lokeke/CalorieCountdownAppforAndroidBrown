...
public class FivePMBoxService_CIFragement001 extends Service
{
    ...
    private static final String ACTION_SET_FIVEPM_NOTIFICATION = "ese.com.caloriecountdownappforandroid.action.FIVEPM_NOTIFICATION";
    private static int REQUEST_CODE_NEW_DAY_FIVE_PM = 33;





    public FivePMBoxService_CIFragement001()
    {
        ...
        {
            CharSequence name = "FivePM";
            String channel_id = "FivePM1";
            String channel_description = "This is a Five pm description";
    ...
    public FivePMBoxService_CIFragement001(SpecialThreadCIF15 IN)
    {
        mSpecialThread = IN;
        goey = IN.goey;
        mAlarmManager = (AlarmManager)goey.getSystemService(Context.ALARM_SERVICE);
    ...
    public FivePMBoxService_CIFragement001(SpecialThreadCIF15 INSIDE, NotificationManager IN, NotificationCompat.Builder INPUT, Date notificationtime, PendingIntent pendingIntent)
    {
    ...
    public void onCreate()
    {
        ...
        ///mNotificationManager.notify(0, mBuilder.build());
        // mNotificationManager.notify(0, mBuilder.build());
        android.util.Log.d("Noftify","We are in Repeating Daybreak FiveDayEnd");
...
// constants--in this case, AlarmManager.INTERVAL_DAY.
        ...
        final Runnable r = new Runnable()
        {
            public void run()
            {
                ...
                CCD_GUI_CD_CIF1.instance.Start_Day_End();
