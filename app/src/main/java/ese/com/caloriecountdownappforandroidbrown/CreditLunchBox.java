 ...
 * helper methods.
 */
public class CreditLunchBox extends IntentService {
    ...
    private static int REQUEST_CODE_LUNCH = 9;
    ...
    public static void startActionCreditBalance(Context context, String param1, String param2) {
        ...
        intent.setAction(ACTION_CREDIT_LUNCH_TRANSACTION);
    ...
    public static void startActionBaz(Context context, String param1, String param2) {
        Intent intent = new Intent(context, CreditLunchBox.class);
    ...
    public CreditLunchBox() {
        super("Credit Breakfast Transaction"); //from i Green, can also get from Orange especially Brown(print) IDO.
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        android.util.Log.d("CreditLunchTransation","Do we ever enter event handling by Service?");

        if (intent != null) {
            final String action = intent.getAction();
            if (ACTION_CREDIT_LUNCH_TRANSACTION.equals(action)) {
                //final String param1 = intent.getStringExtra(EXTRA_BALANCE);
                //final String param2 = intent.getStringExtra(EXTRA_PARAM2);
                //handleActionStoreBalance(param1, param2);
                android.util.Log.d("CreditLunchTransaction","We are in Intent and have registered Action Credit Lunch Handle");
            ...
            else android.util.Log.d("CreditLunchTransaction","Action Breakfast Transaction Handle NOT DETECTED");
        }
    }
    ...
    {
        android.util.Log.d("Lunch Transaction", "Made at Lunch Log it In Service do stuff, restart");
        MIF4_Data_Model_Adapter data_model_adapter = new MIF4_Data_Model_Adapter(CreditLunchBox.this);
        ...
        Toaster("Credit Lunch Transaction: Hit Ok and the Credit button in App and record all Food Items in your Lunch Box");
